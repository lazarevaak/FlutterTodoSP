...
class Contact extends DataClass implements Insertable<Contact> {
  ...
  Contact copyWith({int? id, String? name, String? phone}) => Contact(
    id: id ?? this.id,
    name: name ?? this.name,
    ...
    : super(
        TableManagerState(
          ...
          updateCompanionCallback:
              ...
              }) => ContactsCompanion(id: id, name: name, phone: phone),
          createCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                required String name,
                required String phone,
              }) => ContactsCompanion.insert(id: id, name: name, phone: phone),
